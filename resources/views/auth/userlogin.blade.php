...
<body style="width: 100%;height: 650px;" class="d-flex justify-content-center align-items-center ">
    <form action="/logout" method="post"
        class="bg-light col-5 border border-1 rounded-2 h-50 align-items-center d-flex flex-column justify-content-center ">
        @csrf
        <div class="w-75 h-50 ">
        ...
        <input type="submit" name="login" class="btn btn-primary col-6 " value="Login">
        <div style="height: 10px"></div>
        <input type="submit" name="signup" class="btn btn-primary col-6" value="Sign Up">
    </form>
</body>
